...
# argument parser for terminal input
    ...
    parser.add_argument('--prompt', type=str, required=False, help='Prompt for generation')
    ...
    # def stable_diffusion(prompt, src_img, prompt_strength):
    ...
    # stable_diffusion(prompt=args.prompt, src_img='interactive/data/dream.jpg', prompt_strength=0.3)
