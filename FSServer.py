...
if __name__ == '__main__':
    ...
    while not server2.should_close():
        ...
        print('opening videohandler in syphon')
        frame_FS = VideoHandler(args.video_path, args.src_img, args).start()
        ...
        print('sending frame to syphon')
        server2.draw_and_send(frame_FS)
