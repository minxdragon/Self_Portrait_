...
model.add(Dropout(0.25))
model.add(Flatten())
model.add(Dense(64, input_dim=64, kernel_regularizer=regularizers.l1(0.1)))
model.add(Activation('relu'))
model.add(Dense(64, kernel_regularizer=regularizers.l1(0.1)))
model.add(Activation('relu'))
model.add(Dense(75, kernel_regularizer=regularizers.l1(0.1)))
