...
model.add(Dropout(0.25))
model.add(Flatten())
model.add(Dense(64, input_dim=64, kernel_regularizer=regularizers.elastic_net(alpha=0.01, l1_ratio=0.5)))
model.add(Activation('relu'))
model.add(Dense(64, kernel_regularizer=regularizers.elastic_net(alpha=0.01, l1_ratio=0.5)))
model.add(Activation('relu'))
model.add(Dense(10, kernel_regularizer=regularizers.elastic_net(alpha=0.01, l1_ratio=0.5)))
